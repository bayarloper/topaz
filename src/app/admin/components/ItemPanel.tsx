...
const PersonRequests: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get<Request[]>("http://13.229.95.135:3001/api/personReq")
      .then((res) => {
  ...
  const handleDeleteRequest = (id: number): void => {
    axios
      .delete(`http://13.229.95.135:3001/api/personReq/${id}`)
      .then((res) => {
  ...
  const handleSaveRequest = (): void => {
    if (showEditModal && requestToEdit) {
      axios
        .put(
          `http://13.229.95.135:3001/api/personReq/${requestToEdit.id}`,
          formData
        )
        .then((res) => {
          console.log(res.data);
      ...
      axios
        .post("http://13.229.95.135:3001/api/personReq", formData)
        .then((res) => {
          console.log(res.data);
          axios
            .get<Request[]>("http://13.229.95.135:3001/api/personReq")
