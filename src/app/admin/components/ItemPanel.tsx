...
const PersonRequests: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get<Request[]>("https://topaz-six.vercel.app//api/personReq")
      .then((res) => {
  ...
  const handleDeleteRequest = (id: number): void => {
    axios
      .delete(`https://topaz-six.vercel.app//api/personReq/${id}`)
      .then((res) => {
  ...
  const handleSaveRequest = (): void => {
    if (showEditModal && requestToEdit) {
      axios
        .put(
          `https://topaz-six.vercel.app//api/personReq/${requestToEdit.id}`,
          formData
        )
        .then((res) => {
          console.log(res.data);
      ...
      axios
        .post("https://topaz-six.vercel.app//api/personReq", formData)
        .then((res) => {
          console.log(res.data);
          axios
            .get<Request[]>("https://topaz-six.vercel.app//api/personReq")
