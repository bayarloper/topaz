...
const Services: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get<Service[]>("https://topaz-six.vercel.app//api/services")
      .then((res) => {
  ...
  const handleDeleteService = (id: number): void => {
    axios
      .delete(`https://topaz-six.vercel.app//api/services/${id}`)
      .then((res) => {
  ...
  const handleSaveService = (): void => {
    if (showEditModal && serviceToEdit) {
      axios
        .put(
          `https://topaz-six.vercel.app//api/services/${serviceToEdit.id}`,
          formData
        )
        .then((res) => {
          console.log(res.data);
      ...
      axios
        .post("https://topaz-six.vercel.app//api/services", formData)
        .then((res) => {
          console.log(res.data);
          axios
            .get<Service[]>("https://topaz-six.vercel.app//api/services")
