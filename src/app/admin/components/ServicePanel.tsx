...
const Services: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get<Service[]>("http://13.229.95.135:3001/api/services")
      .then((res) => {
  ...
  const handleDeleteService = (id: number): void => {
    axios
      .delete(`http://13.229.95.135:3001/api/services/${id}`)
      .then((res) => {
  ...
  const handleSaveService = (): void => {
    if (showEditModal && serviceToEdit) {
      axios
        .put(
          `http://13.229.95.135:3001/api/services/${serviceToEdit.id}`,
          formData
        )
        .then((res) => {
          console.log(res.data);
      ...
      axios
        .post("http://13.229.95.135:3001/api/services", formData)
        .then((res) => {
          console.log(res.data);
          axios
            .get<Service[]>("http://13.229.95.135:3001/api/services")
